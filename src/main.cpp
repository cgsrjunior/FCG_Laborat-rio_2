...
//Aqui vao as coordenadas x, y, z e o angulo de rotacao r para a funcao de free camera
float x;
float y;
float z;
float r;

//Aqui iremos colocar as coordenadas iniciais da camera e definir vetores auxiliares
...
int main()
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(800, 800, "INF01047 - Cleiber Rodrigues - 00271039", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
...
GLuint LoadShader_Fragment(const char* filename)
{
    ...
    // Carregamos e co mpilamos o shader
...
void KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mod)
{
    ...
    //   Se apertar tecla W       então tz += delta;
    //   Se apertar tecla S       então tz -= delta;
    //   Se apertar tecla A       então tx += delta;
    //   Se apertar tecla D       então tx -= delta;
    //   Se segurar mouse_esq e mover o mouse
    //   Entao temos que atualizar os angulos da camera
